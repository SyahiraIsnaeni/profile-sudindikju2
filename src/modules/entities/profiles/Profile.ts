export class Profile {
  ...
  isVisiMisiEmpty(): boolean {
    return !this.vision && !this.mission && !this.motto;
  }

  isStructureEmpty(): boolean {
    return !this.structure_org;
  }

  isMaklumatEmpty(): boolean {
    return !this.maklumat;
  }

  isTugasFungsiEmpty(): boolean {
    return !this.task_org && !this.function_org;
  }
}
