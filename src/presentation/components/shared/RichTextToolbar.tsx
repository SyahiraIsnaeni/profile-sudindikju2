    ...
    return (
        <div className="flex items-center gap-2 bg-gray-100 p-3 border-b border-gray-300 flex-wrap">
            ...
            <div className="relative">
                ...
                {showColorPicker && (
                    <div className="absolute top-full left-0 mt-1 bg-white border border-gray-300 rounded-lg p-3 shadow-lg z-10 grid grid-cols-4 gap-2 w-48">
                        {textColors.map((color) => (
                            <button
                                key={color.value}
                                onClick={() => handleTextColor(color.value)}
                                className="flex items-center gap-2 px-3 py-2 hover:bg-gray-100 rounded transition text-sm"
                            >
                                <div
